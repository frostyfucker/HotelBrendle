        ...
        floors: [
            {
                ...
                rooms: [
                    ...
                    { 
                        ...
                        status: 'vacant-clean',
                        workOrders: [
                             { id: 'wo-hist-102-1', title: 'Paint touch-up on wall', date: '2024-06-10', estimatedCost: 50.00, priority: 'Low', status: 'Completed', description: 'Touched up scuff marks near the entrance.' },
                        ]
                    },
                    { 
                      id: '103', 
                      ...
                      workOrders: [
                        ...
                        { id: 'wo-hist-103-1', title: 'Carpet deep clean', date: '2024-01-20', estimatedCost: 150.00, priority: 'Low', status: 'Completed', description: 'Scheduled deep cleaning for all carpets.' }
                      ]
                    },
