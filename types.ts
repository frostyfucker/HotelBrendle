...
export type View = 'dashboard' | 'renovation-advisor' | 'budget-tracker' | 'maintenance-repair' | 'hotel-pulse' | 'guest-services' | 'local-guide' | 'time-clock' | 'inventory' | 'session-summarizer';
